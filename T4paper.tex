...
%DLM: "signalling" is the British spelling: http://www.english-for-students.com/American-Spelling.html ; should be "signaling".
...
Here, we apply the same FEP protocol, which utilizes replica exchange with solute tempering (FEP/REST)\cite{FEP/REST}, to a very simple model binding site in an engineered mutant of T4 lysozyme (L99A).
