...
\begin{subfigure}{\textwidth}
   ...
   \label{fig:C2O}
    %\frame{\includegraphics[scale=0.25, trim={5cm 3cm 3cm 1cm}, clip, width=\linewidth, height=0.4\textheight]{Figures/Protein/C2O.png}}
   \frame{\includegraphics[trim={5cm 3cm 3cm 1cm}, clip, height=0.4\textheight]{Figures/Protein/C2O.png}}
\end{subfigure}\hfill
\centering
\begin{subfigure}{.4\textwidth}
  \centering
  %\frame{\includegraphics[trim={1cm 1cm 8cm 2cm}, clip, width=\linewidth, height=0.3\textheight]{Figures/Protein/Glu108-C2O.png}}
   \frame{\includegraphics[trim={0cm 0cm 8cm 2cm}, clip, height=0.4\textheight]{Figures/Protein/Glu108-C2O.png}}
   \caption{Residue Glu108}
   \label{fig:Glu108-C2O}
\end{subfigure}\hfill
\begin{subfigure}{.5\textwidth}
   \centering
   %\frame{\includegraphics[trim={5cm 1cm 0cm 3cm}, clip, width=\linewidth, height=0.3\textheight]{Figures/Protein/Val111-C2O.png}}
