...
\begin{subfigure}{\textwidth}
   ...
   \frame{\includegraphics[trim={1.5cm 0 2cm 0.25cm}, clip, width=\linewidth, height=0.4\textheight]{VMDscripts/c_opls3_1/plots/0-5ns/RMSD-replica11.png}}
\end{subfigure}
\centering
\begin{subfigure}{\textwidth}
  \centering
  \frame{\includegraphics[trim={1.5cm 0 2cm 0.25cm}, clip, width=\linewidth, height=0.4\textheight]{VMDscripts/o_opls3_1/plots/0-5ns/RMSD-replica11.png}}
...
\begin{subfigure}{\textwidth}
   ...
   \frame{\includegraphics[trim={1.5cm 0 2cm 0.25cm}, clip, width=\linewidth, height=0.4\textheight]{VMDscripts/c_exp_opls3_11/plots/0-5ns/RMSD-replica11.png}}
\end{subfigure}
\centering
\begin{subfigure}{\textwidth}
  \centering
   \frame{\includegraphics[trim={1.5cm 0 2cm 0.25cm}, clip, width=\linewidth, height=0.4\textheight]{VMDscripts/o_exp_opls3_24/plots/0-5ns/RMSD-replica11.png}}
   \caption{Protein open simulation}
...
\begin{subfigure}{\textwidth}
   ...
   \frame{\includegraphics[trim={1.5cm 0 2cm 0.25cm}, clip, width=\linewidth, height=0.4\textheight]{VMDscripts/c_opls3_rest1_extend_1e/plots/0-5ns/RMSD-replica11.png}}
\end{subfigure}
\centering
\begin{subfigure}{\textwidth}
  \centering
   \frame{\includegraphics[trim={1.5cm 0 2cm 0.25cm}, clip, width=\linewidth, height=0.4\textheight]{VMDscripts/c_opls3_rest1_extend_1e/plots/45-55ns/RMSD-replica11.png}}
...
\begin{subfigure}{.5\textwidth}
  ...
  \caption{Default}
   ...
   \frame{\includegraphics[width=\linewidth, height=0.4\textheight]{VMDscripts/c_opls3_1/plots/colormap/cmap-0-5ns.png}}
\end{subfigure}\hfill
\begin{subfigure}{.5\textwidth}
   \centering
    \caption{pREST}
   \label{fig:c_opls3_rest1_1/colormap}
   \frame{\includegraphics[width=\linewidth, height=0.4\textheight]{VMDscripts/c_opls3_rest1_extend_1e/plots/colormap/cmap-0-5ns.png}}

\end{subfigure}\hfill
\centering
\begin{subfigure}{\textwidth}
   \centering
   \frame{\includegraphics[clip, width=\linewidth, height=0.4\textheight]{VMDscripts/c_opls3_rest1_extend_1e/plots/colormap/cmap-45-55ns.png}}
