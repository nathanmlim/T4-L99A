...
\begin{subfigure}[t]{0.5\linewidth}
   ...
   \frame{\includegraphics[clip, height=0.25\textheight, width=\linewidth]{VMDscripts/Figures/T4_lysozyme_edit.png}}
\end{subfigure}\hfill
\centering
\begin{subfigure}[t]{0.5\linewidth}
  \centering
  ...
  \frame{\includegraphics[trim={8cm 8cm 12cm 3cm}, clip, height=0.25\textheight, width=\linewidth]{VMDscripts/Figures/ProteinTube.png}}
\end{subfigure}\hfill
...
\begin{subfigure}{\textwidth}
   ...
   \label{fig:C2O}
   \frame{\includegraphics[trim={5cm 2cm 3cm 1cm}, clip, width=\linewidth, height=0.4\textheight]{VMDscripts/Figures/C2O.png}}
\end{subfigure}
\centering
\begin{subfigure}{.45\textwidth}
  \centering
   \frame{\includegraphics[trim={1cm 1cm 8cm 2cm}, clip, width=\linewidth, height=0.4\textheight]{VMDscripts/Figures/Glu108-C2O.png}}
   \caption{Residue Glu108}
   \label{fig:Glu108-C2O}
\end{subfigure}\hfill
\begin{subfigure}{.45\textwidth}
   \centering
   \frame{\includegraphics[trim={5cm 0cm 0cm 1cm}, clip, width=\linewidth, height=0.4\textheight]{VMDscripts/Figures/Val111-C2O.png}}
...
\begin{subfigure}{\textwidth}
   ...
   \frame{\includegraphics[trim={1.5cm 0 2cm 0.25cm}, clip, width=\linewidth, height=0.3\textheight]{VMDscripts/c_opls3_1/plots/0-5ns/RMSD-replica11.png}}
\end{subfigure}
\centering
\begin{subfigure}{\textwidth}
  \centering
  \frame{\includegraphics[trim={1.5cm 0 2cm 0.25cm}, clip, width=\linewidth, height=0.3\textheight]{VMDscripts/o_opls3_1/plots/0-5ns/RMSD-replica11.png}}
...
\begin{subfigure}{\textwidth}
   ...
   \frame{\includegraphics[trim={1.5cm 0 2cm 0.25cm}, clip, width=\linewidth, height=0.3\textheight]{VMDscripts/c_exp_opls3_11/plots/0-5ns/RMSD-replica11.png}}
\end{subfigure}
\centering
\begin{subfigure}{\textwidth}
  \centering
   \frame{\includegraphics[trim={1.5cm 0 2cm 0.25cm}, clip, width=\linewidth, height=0.3\textheight]{VMDscripts/o_exp_opls3_24/plots/0-5ns/RMSD-replica11.png}}
   \caption{Protein open simulation}
...
\begin{subfigure}{\textwidth}
   ...
   \frame{\includegraphics[trim={1.5cm 0 2cm 0.25cm}, clip, width=\linewidth, height=0.3\textheight]{VMDscripts/c_opls3_rest1_extend_1e/plots/0-5ns/RMSD-replica11.png}}
\end{subfigure}
\centering
\begin{subfigure}{\textwidth}
  \centering
   \frame{\includegraphics[trim={1.5cm 0 2cm 0.25cm}, clip, width=\linewidth, height=0.3\textheight]{VMDscripts/c_opls3_rest1_extend_1e/plots/45-55ns/RMSD-replica11.png}}
...
\begin{subfigure}{.5\textwidth}
  ...
  \caption{Default}
   ...
   \frame{\includegraphics[width=\linewidth, height=0.3\textheight]{VMDscripts/c_opls3_1/plots/colormap/cmap-0-5ns.png}}
\end{subfigure}\hfill
\begin{subfigure}{.5\textwidth}
   \centering
    \caption{pREST}
   \label{fig:c_opls3_rest1_1/colormap}
   \frame{\includegraphics[width=\linewidth, height=0.3\textheight]{VMDscripts/c_opls3_rest1_extend_1e/plots/colormap/cmap-0-5ns.png}}

\end{subfigure}\hfill
\centering
\begin{subfigure}{\textwidth}
   \centering
   \frame{\includegraphics[clip, width=\linewidth, height=0.3\textheight]{VMDscripts/c_opls3_rest1_extend_1e/plots/colormap/cmap-45-55ns.png}}
...
\begin{subfigure}{.5\textwidth}
  \centering
   ...
   \frame{\includegraphics[width=\linewidth, height=0.3\textheight]{VMDscripts/XYplot/C2O_xyplot.png}}
\end{subfigure}\hfill
\begin{subfigure}{.5\textwidth}
   \centering
  \caption{Closed-Open: pREST}
   \label{fig:C2O_xyplot_pREST}
   \frame{\includegraphics[width=\linewidth, height=0.3\textheight]{VMDscripts/XYplot/C2O_pREST_xyplot.png}}
\end{subfigure}\hfill
\centering
\begin{subfigure}{.5\textwidth}
  \centering
   \frame{\includegraphics[width=\linewidth, height=0.3\textheight]{VMDscripts/XYplot/C2I_xyplot.png}}
   \caption{Closed-Intermediate: Default}
   \label{fig:C2I_xyplot}
\end{subfigure}\hfill
\begin{subfigure}{.5\textwidth}
   \centering
   \frame{\includegraphics[width=\linewidth, height=0.3\textheight]{VMDscripts/XYplot/C2I_pREST_xyplot.png}}
...
\begin{subfigure}{.5\textwidth}
  \centering
   ...
   \frame{\includegraphics[width=\linewidth, height=0.3\textheight]{VMDscripts/XYplot/exp_xyplot.png}}
\end{subfigure}\hfill
\begin{subfigure}{.5\textwidth}
   \centering
      \caption{pREST}
   \label{fig:exp_xyplot_pREST}
   \frame{\includegraphics[width=\linewidth, height=0.3\textheight]{VMDscripts/XYplot/exp_pREST_xyplot.png}}
\end{subfigure}\hfill
